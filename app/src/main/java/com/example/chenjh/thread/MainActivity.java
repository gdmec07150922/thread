package com.example.chenjh.thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void anr(View v){
        for (int i=0;i<100000;i++){
            BitmapFactory.decodeResource(getResources(),R.drawable.androids);
    ...
    public void timnertask(View v){
        ...
        MyThread thread2=new MyThread("线程一");
